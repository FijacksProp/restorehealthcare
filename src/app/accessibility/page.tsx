...
export default function AccessibilityPage() {
  return <PolicyLayout title="Accessibility statement" intro="Restore Healthcare Solutions Limited wants this website to be usable by as many people as possible, including people who use assistive technology or navigate without a mouse.">
    ...
    <section><h2>Feedback</h2><p>If any content is difficult to access, visitors can call Restore using the numbers on the Contact page. Please describe the page, the problem encountered and the preferred way to receive the information.</p></section>
