...
export default function HowCareWorksPage() {
  return (
    <>
      <PageHero eyebrow="How care works" title="A thoughtful path from questions to support." intro="Arranging care can feel like a big decision. Our process is designed to replace uncertainty with calm, clear steps."><Link className="button button--light" href="/contact">Start a conversation <ArrowRight size={18} /></Link></PageHero>
